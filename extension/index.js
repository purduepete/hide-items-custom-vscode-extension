...
function activate(context) {
  ...
  const currentVersion = context.globalState.get("hide-items-custom.version");
  const packageVersion = vscode.extensions.getExtension(
    "lerxst.hide-items-custom"
  ).packageJSON.version;
  ...
  if (currentVersion !== packageVersion) {
    ...
    context.globalState.update("hide-items-custom.version", packageVersion);
  ...
  const disableAll = vscode.commands.registerCommand(
    "hide-items-custom.disableAll",
    () => {
  ...
  const enableAll = vscode.commands.registerCommand(
    "hide-items-custom.enableAll",
    () => {
  ...
  const openSettings = vscode.commands.registerCommand(
    "hide-items-custom.openSettings",
    () => {
  ...
  const toggleAllOff = vscode.commands.registerCommand(
    "hide-items-custom.toggleAllOff",
    () => {
  ...
  const toggleAllOn = vscode.commands.registerCommand(
    "hide-items-custom.toggleAllOn",
    () => {
