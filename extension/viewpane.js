...
class ViewPane {
  ...
  getTreeItem(node) {
    ...
    treeItem.tooltip = enabled
      ? localize("tooltip.show", title)
      : localize("tooltip.hide", title);
    treeItem.description =
      this.defaultExclude.indexOf(title) > -1 ? "system" : "";
    treeItem.command = {
      command: "hide-items-custom.toggle",
      title: title,
      arguments: [title],
    };
